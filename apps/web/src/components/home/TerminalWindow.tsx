...
export function TerminalWindow({ children, title = 'Terminal' }: TerminalWindowProps) {
  return (
    <div className="rounded-[var(--n-radius-lg)] border border-[var(--border)] bg-[#0a0a0a] overflow-hidden shadow-lg h-full flex flex-col">
      ...
      <div className="p-4 font-mono text-sm text-[#e0e0e0] flex-1 overflow-hidden">
        {children}
      </div>
    </div>
  )
