...
const OPEN_SOURCE_FEATURES = [
  ...
  { icon: Blocks, title: 'Embed any React component', desc: 'Live demos, interactive charts, product features -- anything React can render.' },
  { icon: Film, title: 'Remotion and beyond', desc: 'Cinematic animations with Remotion, Three.js, or any library you want.' },
