...
export function DeckTagEditor({ deckId, deckTags, allTags, onTagsChange, onTagLibraryChange, onClose }: DeckTagEditorProps) {
  ...
  return (
    <div ref={ref} className="relative">
      <div className="w-72 rounded-[var(--n-radius-md)] border border-[var(--border)] bg-[var(--popover)] p-3 shadow-lg">
        <div className="mb-2 flex items-center justify-between">
          <span className="text-xs font-medium text-[var(--muted-foreground)]">Tags</span>
          {onClose && (
            <button
              type="button"
              onClick={onClose}
