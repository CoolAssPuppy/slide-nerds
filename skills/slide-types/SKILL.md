...
```tsx
<section data-slide="">
  <div className="flex flex-col items-center justify-center min-h-screen text-center" style={{ padding: 'var(--slide-padding)' }}>
...
```tsx
<section data-slide="">
  <div className="flex items-center justify-center min-h-screen" style={{ background: 'var(--color-primary)', padding: 'var(--slide-padding)' }}>
...
<section data-slide="">
  <div className="flex flex-col items-center justify-center min-h-screen text-center" style={{ padding: 'var(--slide-padding)' }}>
    <p className="text-8xl font-bold" style={{ color: 'var(--color-accent)' }}>$4.2M</p>
...
```tsx
<section data-slide="">
  <div className="flex flex-col items-center justify-center min-h-screen text-center" style={{ padding: 'var(--slide-padding)', maxWidth: '800px', margin: '0 auto' }}>
...
<section data-slide="">
  <div style={{ padding: 'var(--slide-padding)' }}>
    ...
    <pre className="rounded-lg p-6 text-sm overflow-x-auto" style={{ background: 'var(--color-surface)' }}>
      <code data-step="" className="block">{'const runtime = new SlideRuntime()'}</code>
      <code data-step="" className="block mt-2">{'runtime.registerSlides(document)'}</code>
      <code data-step="" className="block mt-2">{'runtime.start()'}</code>
    </pre>
  </div>
</section>
```
    ...
    <table className="w-full text-left text-lg">
      ...
      <tbody>
        <tr data-step="" className="border-b" style={{ borderColor: 'var(--color-surface)' }}>
          ...
          <td className="py-3" style={{ color: 'var(--color-accent)' }}>Fast</td>
          <td className="py-3 opacity-50">Slow</td>
        </tr>
        <tr data-step="" className="border-b" style={{ borderColor: 'var(--color-surface)' }}>
          <td className="py-3">Price</td>
          <td className="py-3" style={{ color: 'var(--color-accent)' }}>$4/mo</td>
  ...
  <div style={{ padding: 'var(--slide-padding)' }}>
    ...
    <div className="grid grid-cols-3 gap-8">
      <div data-step="" className="text-center">
        <div className="w-24 h-24 rounded-full mx-auto mb-4" style={{ background: 'var(--color-surface)' }} />
  ...
  <div style={{ padding: 'var(--slide-padding)' }}>
    ...
    <div className="flex justify-between items-start">
      <div data-step="" className="text-center flex-1">
        <div className="w-4 h-4 rounded-full mx-auto" style={{ background: 'var(--color-accent)' }} />
...
<section data-slide="">
  <div className="relative min-h-screen">
    ...
    <div className="relative z-10 flex items-end min-h-screen" style={{ padding: 'var(--slide-padding)' }}>
      <div>
...
```tsx
<section data-slide="">
  <div className="grid grid-cols-2 gap-8 items-center min-h-screen" style={{ padding: 'var(--slide-padding)' }}>
    <div>
...
```tsx
<section data-slide="">
  <div className="flex items-center justify-center min-h-screen" style={{ padding: 'var(--slide-padding)' }}>
